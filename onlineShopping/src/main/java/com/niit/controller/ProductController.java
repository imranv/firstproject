...
import com.niit.shoppingcart.util.newstring;
import com.niit.shoppingcartDAO.CategoryDAO;
import com.niit.shoppingcartDAO.ProductDAO;
	...
	//for add and update category both
		...
		public String editProduct(@PathVariable("id") String id, Model model) {
			...
			public String getSelectedProduct(@PathVariable("id") String id,Model model,RedirectAttributes redirectAttributes)
			{
				...
				model.addAttribute("Catname",this.productDAO.getProduct(id).getCategory().getName());
				model.addAttribute("Suppliername",this.productDAO.getProduct(id).getSupplier().getName());
				System.out.println("category name of the selected product is "+productDAO.getProduct(id));
				System.out.println("supplier name of the selected product is "+this.productDAO.getProduct(id).getSupplier().getName());
				model.addAttribute("categoryList",this.categoryDAO.list());
